    ...
    <main style={{ background: '#fff' }}>
      ...
      <section className="hero" style={{ padding: '12rem 0 8rem' }}>
        <div className="container text-center">
          <h3 className="hero-subtitle">CONTACT US</h3>
          <h1 style={{ fontSize: '4rem', fontWeight: '800', marginBottom: '1.5rem', letterSpacing: '-2px' }}>
      ...
      <section className="section" style={{ marginTop: '-6rem', padding: '0 0 4rem', position: 'relative', zIndex: 10 }}>
        <div className="container">
          <div className="grid-2">
            <div className="capability-card text-center" style={{ padding: '3.5rem 2rem', boxShadow: '0 20px 40px rgba(0,0,0,0.08)', border: 'none' }}>
      ...
      <section className="section bg-light" style={{ padding: '8rem 0' }}>
        <div className="container">
          <div className="grid-2" style={{ alignItems: 'center', gap: '5rem' }}>
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                  <div style={{ display: 'flex', gap: '1.2rem', alignItems: 'center' }}>
                    <div style={{ width: '56px', height: '56px', borderRadius: '50%', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
            ...
            {/* Map */}
            <div style={{ width: '100%', height: '450px', background: '#111', borderRadius: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', position: 'relative', boxShadow: '0 40px 80px rgba(0,0,0,0.15)' }}>
              {/* Decorative map element */}
              <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', opacity: 0.2, background: 'radial-gradient(circle at 30% 40%, var(--primary) 0%, transparent 60%)' }}></div>
              <div style={{ textAlign: 'center', color: '#fff', position: 'relative', zIndex: 1 }}>
                <div style={{ width: '80px', height: '80px', borderRadius: '50%', background: 'rgba(255,189,0,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem' }}>
