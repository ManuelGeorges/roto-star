  ...
  const capabilities = [
    {
      ...
      image: "https://image.made-in-china.com/202f0j00UBEiOkfKOVGY/1050mm-8-Color-High-Speed-New-Gravure-Rotogravure-Printing-Machine-Press.webp"
    },
    {
    ...
    },
    {
      ...
      image: "https://cdn.builtin.com/cdn-cgi/image/f=auto,fit=cover,w=1200,h=635,q=80/sites/www.builtin.com/files/2025-03/advanced-materials-companies.jpg"
    },
    {
            ...
            {capabilities.map((cap, i) => (
              <div key={i} className={`capability-card animate-fade-up delay-${(i % 2) + 1}`} style={{ padding: 0, display: 'flex', overflow: 'hidden', minHeight: '300px' }}>
                <div style={{ width: '40%', position: 'relative', overflow: 'hidden' }}>
                   <img src={cap.image} alt={cap.title} style={{ width: '100%', height: '100%', objectFit: 'cover', transition: 'transform 0.5s ease' }} className="hover-zoom" />
